...
public class FormArt extends Stage {
    ...
    private TextField txtcancionArt;
    ...
    public FormArt(TableView<ArtistaDAO> tbv, ArtistaDAO objA) {
        ...
        if (objA != null) {
            ...
            txtcancionArt.setText(objArt.getCancion());
    ...
    private void CrearUI() {
        ...
        txtcancionArt = new TextField();
        txtcancionArt.setPromptText("Canción del artista");

        btnGuardar = new Button("Guardar");
        btnGuardar.setOnAction(actionEvent -> GuardarArtista());

        vbox = new VBox(txtnomArt, txtcancionArt, btnGuardar);
    ...
    private void GuardarArtista() {
        ...
        objArt.setCancion(txtcancionArt.getText());
        String msj;
